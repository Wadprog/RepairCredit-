                ...
                <div className='row mb-3'>
                    <div className='col-12 d-flex justify-content-between'>
                        ...
                        <span>
                            ...
                            <Button variant="secondary" type="submit" size="sm" className="mx-3">
                ...
                <div className='row my-3'>
                    <div className='col-12 d-flex justify-content-between'>
                        <Form className="form-inline">
                            ...
                            <Link to="#" className="mx-3">Advanced search</Link>
                            <Button variant="primary" type="submit" size="sm" className="mx-3">
                                Search
                             </Button>
                        </Form>
                ...
                <div className='row mb-3'>
                    <div className='col-12 d-flex justify-content-between'>
                        <Form className="form-inline">
                            ...
                            <Link to="#" className="mx-2">click here</Link>
                        </Form>
                        <div className="align-self-center">
                            <Link to="#" className="mx-2">Import CSV</Link>
                            <Link to="#" className="mx-2">Export CSV</Link>
                            <Link to="#" className="mx-2">print</Link>
                        </div>
                    </div>
                </div>
                <div className="Row">
